(function () {
    ...
    describe('add/edit student', function () {
        ...
        beforeEach(module(function ($provide) {
            ...
            $provide.factory('student', function () {
                return {};
            });
        }));

        beforeEach(inject(function ($controller, _$httpBackend_, _$uibModalInstance_) {
            ctrl = $controller('StudentEditDialogController');
        ...
        it('should call resource save when save clicked', function () {
            $httpBackend.expectPOST('./api/students').respond(200);
